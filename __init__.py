...
try:
    ...
    from .qwen3_VL_model_loader import NODE_CLASS_MAPPINGS as QWEN3_VL_LLM_MODEL_LOADER_MAPPINGS
    from .qwen3_VL_model_loader import NODE_DISPLAY_NAME_MAPPINGS as QWEN3_VL_LLM_MODEL_LOADER_DISPLAY_MAPPINGS
